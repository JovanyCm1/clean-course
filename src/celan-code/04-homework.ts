...
(() => {
    ...
    // Simplificar esta función usando Object literal
    ...
    // Simplificar esta función - usando early returns
    let isFirstStepWorking  = true;
    let isSecondStepWorking = true;
    let isThirdStepWorking  = true;
    let isFourthStepWorking = true;
    ...
    // workingSteps
    console.log({ workingSteps: workingSteps() }); // Cambiar los valores de la línea 25-28 y esperar los resultados
